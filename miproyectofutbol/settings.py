"""
Django settings for miproyectofutbol project.
...
SECRET_KEY = 'django-insecure-mql7louq@4t^i@w&l5i@mizxf6ho-)adi+zh2wcj_)guzw1&rv'
...
ROOT_URLCONF = 'miproyectofutbol.urls'
...
WSGI_APPLICATION = 'miproyectofutbol.wsgi.application'
